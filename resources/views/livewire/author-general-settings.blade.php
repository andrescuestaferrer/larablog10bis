        ...
        <div class="row">
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <span class="text-danger"> @error('blog_name') {{ $message ?? null}} @enderror </span>
                </div>
                <div class="mb-3">
                    ...
                    <span class="text-danger"> @error('blog_email') {{ $message ?? null}} @enderror </span>
                </div>
                <div class="mb-3">
                    ...
                    <span class="text-danger"> @error('blog_description') {{ $message ?? null}} @enderror </span>
                </div>
